...
// ! comando provisorio 
const relative_path = window.location.pathname.split('/'); //? localiza o local atual do arquivo e transforma em uma lista 
relative_path[0] = window.location.origin; //? adiciona o local de origem da janela na primeira posição 

while(relative_path.at(-1) != 'UI'){ //? verifica se valor da ultima "casa" é "UI"
    relative_path.pop(); //? remove valor da ultima "casa" se não for "UI"
}
const base = relative_path.join("/"); //? junta tudo e coloca barra entre os valores 
